...
| [0005 Sink Handoff 与 Completion](0005-sink-handoff-and-completion.md) | 整组交接、Memory Sink、异步 completion、有限关闭 | Completion/Retry boundary Accepted / M2 API details discussing | 0001、0004 |
| [0006 Failure、Panic 与 Shutdown](0006-failure-panic-and-shutdown.md) | Operator Work Failure Policy、FailJob、panic、错误因果、shutdown | Operator/Sink failure boundary Accepted / error API discussing | 0001、0005 |
